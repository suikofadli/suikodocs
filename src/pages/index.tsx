      ...
      <div className={styles.letterContent}>
        ...
        <div className={styles.introduction}>
          <p className={styles.introText}>
            Inertia.js memungkinkan Anda membangun aplikasi single-page yang
            terasa modern dan cepat, tanpa perlu membuat API terpisah. Dengan
            Inertia, Anda dapat menggunakan framework backend favorit Anda
            sambil tetap memberikan pengalaman pengguna yang smooth.
          </p>
          <p className={styles.introText}>
            Dokumentasi ini tersedia dalam bahasa Indonesia untuk mempermudah
            developer Indonesia dalam mempelajari dan mengimplementasikan
            Inertia.js dalam proyek mereka.
          </p>
        </div>
...
export default function Home() {
  ...
  return (
    <Layout
      ...
      description="Dokumentasi Inertia.js bahasa Indonesia - Build single-page apps, without building an API"
    >
      <HomepageLetter />
    </Layout>
  );
